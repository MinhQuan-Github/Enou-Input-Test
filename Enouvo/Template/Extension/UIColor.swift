...
extension UIColor {
    ...
    static var appPrimaryColor: UIColor {
        ...
        if bundleID == "com.hvnstudio.insect" {
            return UIColor(hex: "3B7EFF")
        } else {
            return UIColor(hex: "2B8951")
        }
    }
    
    static var titleAppPrimaryColor: UIColor {
        let bundleID = Bundle.main.bundleIdentifier
        if bundleID == "com.hvnstudio.insect" {
            return UIColor(hex: "15132F")
        } else {
            return UIColor(hex: "2B8951")
        }
    }
    ...
    static var backgroundColor: UIColor {
        return #colorLiteral(red: 0.8705882353, green: 0.862745098, blue: 0.8862745098, alpha: 1)
    }
    ...
    static func appPrimaryColor(alpha: CGFloat) -> UIColor {
        let bundleID = Bundle.main.bundleIdentifier
        if bundleID == "com.hvnstudio.insect" {
            return UIColor(hex: "3B7EFF", alpha: alpha)
        } else {
            return UIColor(hex: "2B8951", alpha: alpha)
        }
    }
